...
MyLcioEventOutput_DST.DropCollectionTypes = [
    "MCParticle",
    "LCRelation",
    "SimCalorimeterHit",
    "CalorimeterHit",
...
MyLcioEventOutput_DST.FullSubsetCollections = [
    "EfficientMCParticles",
    "InefficientMCParticles",
    "MCPhysicsParticles",
]
MyLcioEventOutput_DST.KeepCollectionNames = [
    "MCParticlesSkimmed",
    "MCPhysicsParticles",
    "RecoMCTruthLink",
    "SiTracks",
